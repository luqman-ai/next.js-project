...
export default function Home() {
  return (
    <main>
      ...
      <p>Getting Ready for the Next Generation and Future of the Internet - Join a 13 Trillion Dollar Industry with 5 Billion Users</p>
      <h2>Certified Web 3.0 and Metaverse Developer: A Nationwide Program in Karachi, Lahore, Islamabad, and Peshawar</h2> 
       <img src="https://www.panaverse.co/red-p-logo-text_dao_croped.png" alt="panaverse image" /> 
              <h3>The Future of the Web is Web 3.0, Metaverse, and Edge Computing. Panaverse DAO is a movement to spread these technolgies globally. It is community of Web 3 and Metaverse developers, designers, trainers, startup founders and service providers.</h3>
       <video src="C:\Users\HP\next.js\public"></video>
        <h4>
...
<h5>The Program in a Nutshell: Earn While You Learn</h5>
...
<h5>Core Courses (Common in All Specializations)</h5> 
<p>Every participant of the program will start by completing the following two core courses:</p>
<h6>
<iframe width="560" height="315" src="https://youtu.be/gGVqxEu2PaA?si=tvqDfAZk2vHupqWG" FrameBorder="0" allowfullscreen></iframe>
Quarter I (Core) CS-101: Object-Oriented Programming using TypeScript

Quarter II (Core) W2-201: Developing Planet-Scale Web 2.0 Serverless Cloud Cloud Apps and APIs using Next.js 13 and Cloud Development Kit (CDK) for Terraform</h6>
<section>
            <table>
                <tr>
                    <th>Header 1</th>
